  ...
  <div class="modal-container" aria-modal="true" role="dialog" hidden="true">
    <div class="modal">
      ...
      <div class="modal__image-container">
        <img src="/img/birthday/birthday1" alt="Food" class="modal__image">
        <img src="/img/birthday/birthday2" alt="Food" class="modal__image">
        <img src="/img/birthday/birthday3" alt="Food" class="modal__image">
        <img src="/img/birthday/birthday4" alt="Food" class="modal__image">
        <img src="/img/birthday/birthday5" alt="Food" class="modal__image">
      </div>
    </div>
  </div>
`)
